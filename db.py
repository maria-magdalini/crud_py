...
class Database:
    def __init__(self,db):
        ...
        self.cur.execute("CREATE TABLE IF NOT EXISTS students (id INTEGER PRIMARY KEY , name TEXT, lastname TEXT, serial INTEGER, university TEXT, semetery INTEGER)")
    ...
    def insert(self, lastname, firstname, serialtag,university,semetery):
        ...
        if rows[0][0] != 0:
            ...
            self.cur.execute("INSERT INTO students VALUES(NULL,?,?,?,?,?)", (lastname, firstname,serialtag, university,semetery))
            self.conn.commit()
    ...
    def update(self,id , firstname,lastname, university, serialtag,student_list,oldStudentsSerial, semetery):
        ...
        if len(res)>1:
            ...
            self.cur.execute("UPDATE students SET lastname = ?, name = ?, university = ?, serial = ?, semetery=? WHERE id=?", (lastname, firstname, university,serialtag,semetery,id))
