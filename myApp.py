...
class PageOne(tk.Frame):
    ...
    def studentSelect(self, event):
            ...
            if len(selected_item) == 0:
                ...
                self.semeteryEntry.delete(0,tk.END)
                ...
                self.semeteryEntry.insert(tk.END, selected_item[5])
    ...
    def __init__(self, parent, controller):
        ...
        self.semeteryLabel = ttk.Label(centerFrame, text="Εξάμηνο")
        self.semeteryLabel.pack( pady=10, padx=10, side="left")
        
        self.semeteryEntry = ttk.Entry(centerFrame, textvariable=semetery)
        self.semeteryEntry.pack( pady=10, padx=10, side="left")
    ...
    #button to add a new user in the database  
        addStudentButton = ttk.Button(buttonsFrame, text="Καταχώρηση Φοιτητή", 
                    ...
                    studentUniversity.get(), studentSerialTag.get(), semetery.get()))
        ...
        updateButton=  ttk.Button ( buttonsFrame, text="Ανανέωση Στοιχείων", command= lambda : db.update(selected_item[0],studentName.get(), studentLastName.get(), 
                    studentUniversity.get(), studentSerialTag.get(), self.student_list, selected_item[3], semetery.get()))
        updateButton.pack(pady=10, padx=10, side='left')
      

        
    def insertStudent(self,studentName,studentLastName,studentUniversity,studentSerialTag, semetery):
        ...
        db.insert(studentName,studentLastName,studentSerialTag,studentUniversity, semetery)
        db.showStudents(self.student_list)
