...
class PageOne(tk.Frame):
    ...
    #create the list box wich the students are been displayed
        ...
        ToolTip(showStudentButton, text="Εμφάνιση όλων των εγγραφών από την βάση δεδομένων", delay=250)
    ...
    #button to add a new user in the database  
        ...
        ToolTip(addStudentButton, text="Καταχώρηση φοιτήτη βάση των στοιχείων εισόδου του χρήστη", delay=250)
        ...
        ToolTip(indexStudentButton, text="Διαγράφή του επιλεγμένου φοιτητή", delay=250)

        clearButton = ttk.Button(buttonsFrame, text="Απαλοιφή", command=clearInputs)
        clearButton.pack(pady=10, padx=10, side='left')
        ToolTip(clearButton, text="Απαλοιφή όλων των πεδίων", delay=250)
        ...
        ToolTip(updateButton, text="Ανανέωση στοιχείων φοιτήτη βάση των στοιχείων εισόδου του χρήστη", delay=250)
